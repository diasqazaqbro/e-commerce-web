				...
				<div class='container'>
					<div class='row'>
						<div class='col-lg-4 col-md-6'>
							...
							>
								<h3 class='f-title f_600 t_color f_size_18'>Страницы</h3>
								<ul class='list-unstyled f_list'>
									<li>
										<Link href='#'>Прогулка и улица</Link>
									</li>
									<li>
										<Link href='#'>Детская комната</Link>
									</li>
									<li>
										<Link href='#'>Игрушки и развлечения</Link>
									</li>
									<li>
										<Link href='#'>Забота и уход</Link>
									</li>
									<li>
						...
						<div class='col-lg-4 col-md-6'>
							...
							>
								...
								<div class='f_social_icon'>
									<Link href='#' class='fab fa-facebook'>
										<svg
									...
									<Link href='#' class='fab fa-pinterest'>
										<svg
											xmlns='http://www.w3.org/2000/svg'
											width='18'
											height='18'
				...
				<div class='container'>
					<div class='row align-items-center'>
						<div class='col-lg-6 col-sm-7'>
							<p class='mb-0 f_400'>© Tatos Inc.. 2023 All rights reserved.</p>
						</div>
